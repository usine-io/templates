...
>
> Ce repo contient les **gabarits et procédures réutilisables**. Les **instances** (fiches-logiciel d'un client donné, PRD POC d'un projet précis) vivent dans le repo du site client correspondant (ex: `spark-kit/kyklos/discovery/`), pas ici.
>
...
| Fiches-logiciel et PRD POC d'un client | `spark-kit/<client>/discovery/` (ex: `spark-kit/kyklos/discovery/`) | par-site, à instancier |
...
Le repo `spark-kit/kyklos` est l'instance de référence de cette convention. Voir https://github.com/spark-kit/kyklos.
